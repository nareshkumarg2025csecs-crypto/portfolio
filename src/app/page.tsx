      ...
      <section id="skills" className="relative w-full min-h-screen py-24 px-6 sm:px-12 md:px-24 snap-start border-t border-dotted border-rust flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8 max-w-7xl mx-auto w-full">
          {Object.entries(skills).map(([category, items]) => (
            <div key={category} className="cursor-hover flex flex-col gap-6 group border border-darkbrown/20 bg-cream p-6 sm:p-8 shadow-md hover:shadow-xl hover:border-rust transition-all duration-500">
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <div className="flex flex-col gap-6 mt-12">
                <a href="mailto:nareshkumar.g.2025.csecs@rajalakshmi.edu.in" className="cursor-hover flex items-center gap-3 font-sans text-xl text-darkbrown hover:text-rust transition-colors w-max">
                  <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-2.023 2.309-3.178 3.927-1.964L5.455 4.64 12 9.548l6.545-4.91 1.528-1.145C21.69 2.28 24 3.434 24 5.457z"/>
                  </svg>
                  Email Me ↗
                </a>
                <a href="https://github.com/nareshkumarg2025csecs-crypto/" target="_blank" rel="noopener noreferrer" className="cursor-hover flex items-center gap-3 font-sans text-xl text-darkbrown hover:text-rust transition-colors w-max">
                  <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://www.linkedin.com/in/naresh-kumar-g-31264939a?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noopener noreferrer" className="cursor-hover flex items-center gap-3 font-sans text-xl text-darkbrown hover:text-rust transition-colors w-max">
                  <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
            ...
            {profile?.resumeUrl && (
              <div className="mt-16 pt-8 border-t border-darkbrown/10">
                <a href={profile.resumeUrl} target="_blank" rel="noopener noreferrer" className="cursor-hover inline-flex items-center gap-4 bg-rust text-cream font-mono text-xs uppercase tracking-widest px-8 py-4 hover:bg-darkbrown transition-colors duration-300">
                  Download Resume
                </a>
              </div>
            )}
